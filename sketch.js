  ...
  var edges;
  var plusone;
  var meteorImg, heartImage, gameoverImg, mountainImg, plusoneImg, resetImg, rockoneImg, rocktwoImg, alienImg;
...
function spacemountains(){
  if(frameCount % 200 === 0){
    ...
    spacemountain.setCollider("circle", 0,60,140);
